              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a href="javascript:;" >
                          ...
                          <span>Kategori<span style="padding-left:2px;"> <i class="fa fa-angle-down"></i></span></span>
                      </a>
                      <ul class="sub">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="index.php?page=jual">Transaksi</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a href="index.php?page=pengaturan">Pengaturan Sistem Kasir</a></li>
                      </ul>
                  </li>
              </ul>
              <!-- sidebar menu end-->
